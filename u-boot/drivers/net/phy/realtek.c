...
static int rtl8211f_config(struct phy_device *phydev)
{
	...
	printf("disable CLKOUT\n");
	phy_write(phydev, MDIO_DEVAD_NONE,
		  MIIM_RTL8211F_PAGE_SELECT, 0xa43);
	phy_write(phydev, MDIO_DEVAD_NONE,
		  0x19, phy_read(phydev, MDIO_DEVAD_NONE, 0x19) & ~0x1);
	phy_write(phydev, MDIO_DEVAD_NONE,
		  MIIM_RTL8211F_PAGE_SELECT, 0x0);
	phy_write(phydev, MDIO_DEVAD_NONE,
		  MII_BMCR, phy_read(phydev, MDIO_DEVAD_NONE, MII_BMCR) | BMCR_RESET);
#endif
...
U_BOOT_PHY_DRIVER(RTL8211F_VD_CG_driver) = {
