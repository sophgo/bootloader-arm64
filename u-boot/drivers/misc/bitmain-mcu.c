...
static const struct mcu_feature mcu_list[] = {
	{
		MCU_BM1684_EVB, "EVB", "BM1684", "STM32",
		.cmd = 0x14,
	},
	{
		MCU_BM1684_SM5_TB, "SM5TB", "BM1684", "STM32",
		.cmd = 0x14,
	},
	{
		MCU_BM1684_SC5, "SC5", "BM1684", "STM32",
		.cmd = 0x14,
	},
	{
		MCU_BM1684_SE5_V1, "SE5V1", "BM1684", "STM32",
		.cmd = 0x14,
	},
	{
		MCU_BM1684_SM5_PB, "SM5PB", "BM1684", "STM32",
		.cmd = 0x14,
	},
	{
		MCU_BM1684_SM5_RB, "SM5RB", "BM1684", "STM32",
		.cmd = 0x14,
	},
	{
		MCU_BM1684_SC5T, "SC5T", "BM1684", "STM32",
		.cmd = 0x14,
	},
	{
		MCU_BM1684_SC5H, "SC5H", "BM1684", "STM32",
		.cmd = 0x14,
	},
	{
		MCU_BM1684_SC5P, "SC5P", "BM1684", "STM32",
		.cmd = 0x14,
	},
	{
		MCU_BM1684_SM5M_PB, "SM5MPB", "BM1684", "STM32",
		.cmd = 0x14,
	},
	{
		MCU_BM1684_SM5M_RB, "SM5MRB", "BM1684", "STM32",
		.cmd = 0x14,
	},
	{
		MCU_BM1684_SM5M_TB, "SM5MTB", "BM1684", "STM32",
		.cmd = 0x14,
	},
	{
		MCU_BM1684_SE5_V2, "SE5V2", "BM1684", "STM32",
		.cmd = 0x14,
	},
	{
		MCU_BM1684_SE6_CTRL, "SE6CTRL", "BM1684", "STM32",
		.cmd = 0x14,
	},
	{
		MCU_BM1684X_EVB, "EVB", "BM1684X", "STM32",
		.cmd = 0x14,
	},
	{
	...
	{
		MCU_BM1684X_SM7M_RB_CTRL, "EVB", "BM1684X", "STM32",
		.cmd = 0x14,
	},
	{
	...
	{
		MCU_BM1684X_SM7_CUST_V1, "EVB", "BM1684X", "STM32",
		.cmd = 0x14,
	},
...
static int do_mcu(struct cmd_tbl *cmdtp, int flag,
...
static int bind_cells(struct mcu_ctx *ctx)
{
	...
	for (i = 0; i < nvmem_cells_count; ++i, ++eeprom_cell) {
		eeprom_cell->node = fdt_node_offset_by_phandle(gd->fdt_blob, nvmem_cells_value[i]);
...
U_BOOT_DRIVER(mcu) = {
	...
	.of_match	= mcu_ids,
	.ops		= &mcu_ops,
	.plat_auto	= sizeof(struct mcu_ctx),
};
