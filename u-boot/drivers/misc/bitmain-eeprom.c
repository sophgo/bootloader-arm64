...
static int __maybe_unused workaround_bmeeprom_read(struct udevice *i2c, int offset, void *buf, int size)
{
...
static int __maybe_unused bmeeprom_read(struct udevice *i2c, int offset, void *buf, int size)
{
	struct i2c_msg msg[2];
	u8 offset_buf[2];
	int err;
