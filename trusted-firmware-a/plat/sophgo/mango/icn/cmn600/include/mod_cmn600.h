...
struct mod_cmn600_config {
    ...
    /*!
     * \brief Table of HN-Fs used in RNSAM
     *
     * \details Each entry of this table corresponds to a HN-F node ID in the
     *      system. The HN-F's Node ID must be sequential in RNSAM HN-F Table
     */
    const unsigned int *hnf_table;
