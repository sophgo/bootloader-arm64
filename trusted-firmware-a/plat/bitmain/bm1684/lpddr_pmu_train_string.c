...
const struct train_msg stream_messages_1d[] = {
	...
	//{0x00ee000b, "PMU5: [%d]:0x %4x %4x %4x %4x %4x %4x %4x %4x %4x %4x\n"},
	...
	{0x00f10001, "PMU5: CS%d <<KEY>> 0 TrainingCntr <<KEY>> coarse(15:10) fine(9:0)\n"},
	{0x00f20001, "PMU5: CS%d <<KEY>> 0 RxEnDly, 1 RxClkDly <<KEY>> coarse(10:6) fine(5:0)\n"},
	{0x00f30001, "PMU5: CS%d <<KEY>> 0 TxDqsDly, 1 TxDqDly <<KEY>> coarse(9:6) fine(5:0)\n"},
	{0x00f40001, "PMU5: CS%d <<KEY>> 0 RxPBDly <<KEY>> 1 Delay Unit ~= 7ps \n"},
	{0x00f50000, "PMU5: all CS <<KEY>> 0 DFIMRL <<KEY>> Units = DFI clocks\n"},
	{0x00f60000, "PMU5: all CS <<KEY>> VrefDACs <<KEY>> DAC(6:0)\n"},
...
const struct train_msg stream_messages_2d[] = {
	...
	{0x00180001, "PMU5: <<KEY>> 0 messageBlock VrefDqR%d <<KEY>> MR6(6:0)\n"},
	{0x00190001, "PMU5: <<KEY>> 0 RxClkDlyTg%d <<KEY>> fine(5:0)\n"},
	...
	{0x002c0003, "PMU0: raw 0x%x allFine %d incDec %d"},
	{0x002d0008, "PMU0: db%d l%d, voltage 0x%x (u_r %d) delay 0x%x (u_r %d) - lcdl %d mask 0x%x\n"},
	...
	{0x006e0005, "PMU4: DB%d L%d   %03d   %03d  ->  %03d\n"},
	...
	{0x00920002, "PMU0: targetting CsX = %d and CsY = %d\n"},
	...
	{0x00a00001, "PMU0: MaxRdLat non consistant DtsmLoThldXingInd 0x%03x\n"},
	...
	{0x00aa0005, "PMU4: DB %d Lane %d: %03d %03d -> %03d\n"},
	...
	{0x00e50000, "PMU: Error: Both 2t timing mode and ddr4 geardown mode specifed in the messageblock's PhyCfg and MR3 fields. Only one can be enabled\n"},
	...
	{0x01280001, "PMU5: CAA%d "},
	{0x01290001, "%02x"},
	{0x012a0000, "\n"},
	{0x012b0001, "PMU5: CAB%d "},
	{0x012c0001, "%02x"},
	{0x012d0000, "\n"},
	...
	{0x01320002, "\nPMU3:InvClk ATxDly setting:%x margin:%d\n"},
	{0x01330000, "\nPMU3:No Range found!\n"},
	{0x01340003, "PMU3: 2 anibi=%d, anibichan[anibi]=%d ,chan=%d"},
	{0x01350002, "\nPMU3: no neg clock => CA setting anib=%d, :%d\n"},
	...
	//{0x0181000b, "PMU5: [%d]:0x %4x %4x %4x %4x %4x %4x %4x %4x %4x %4x\n"},
	...
	{0x01840001, "PMU5: CS%d <<KEY>> 0 TrainingCntr <<KEY>> coarse(15:10) fine(9:0)\n"},
	{0x01850001, "PMU5: CS%d <<KEY>> 0 RxEnDly, 1 RxClkDly <<KEY>> coarse(10:6) fine(5:0)\n"},
	{0x01860001, "PMU5: CS%d <<KEY>> 0 TxDqsDly, 1 TxDqDly <<KEY>> coarse(9:6) fine(5:0)\n"},
	{0x01870001, "PMU5: CS%d <<KEY>> 0 RxPBDly <<KEY>> 1 Delay Unit ~= 7ps \n"},
	{0x01880000, "PMU5: all CS <<KEY>> 0 DFIMRL <<KEY>> Units = DFI clocks\n"},
	{0x01890000, "PMU5: all CS <<KEY>> VrefDACs <<KEY>> DAC(6:0)\n"},
