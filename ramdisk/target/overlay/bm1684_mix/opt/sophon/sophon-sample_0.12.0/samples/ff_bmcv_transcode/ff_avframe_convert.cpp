...
*/
int AVFrameConvert(bm_handle_t &bmHandle,AVFrame *inPic,AVFrame *outPic,int coded_width,int coded_height,int enc_frame_height,int enc_frame_width,
                    int enc_pix_format,int enable_mosaic,int enable_watermark, bm_device_mem_t* watermark){
    ...
    width = inPic->width;
    height = inPic->height;
    inPic->width = coded_width;
    inPic->height = coded_height;
    //release this func
